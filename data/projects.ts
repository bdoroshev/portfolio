...
export const projects: IProject[] = [
	{
		url: 'https://www.true-glue.com/',
		image: '/true-glue.jpg',
		title: 'True Glue',
    description: 'Get the best of both worlds: Performance-packed makeup with no harsh chemicals. Experience clean beauty that acts dirty.',
    ...
    description: 'Paw Pantry a one-stop-shop born to provide everything you need in pet care. Paw Pantry here to help your pet live a happier and healthier life.',
		...
		role: 'Senior Shopify Developer part of Vine Digital team'
	},
	{
